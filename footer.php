<!-- <style>
    ...
    left: 0;
    width: 100%;
    background-color: #1a202c; /* Set the background color accordingly */
}

/* Style the rest of your footer elements as needed */
.flex-footer h2,
.flex-footer ul {
    /* Your styling for h2 and ul elements */
    /* Example styles: */
    margin: 0;
    padding: 0;
}

/* Example: Style for list items */
.flex-footer li {
    list-style: none;
...
<footer class="absolute bg-gray-900 font-onest" aria-labelledby="footer-heading">
    ...
    <div class="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
      ...
      <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
        ...
        <div class="mt-3 rounded-md sm:ml-3 sm:mt-0 sm:flex-shrink-0">
          <button type="submit" class="bg-gray-300 card text-black text-center font-bold px-3 py-1 shadow-xl rounded-2xl inline-block">Subscribe</button>
        </div>
      </form>
    </div>
